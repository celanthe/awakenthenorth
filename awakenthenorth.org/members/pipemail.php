...
MDB::insert("atn_emails", array("from"=>$from, "subject"=>$subject, "headers"=>$headers, "message"=>$message, "received"=>time(), "status"=>0, "raw"=>$email_content));
?>